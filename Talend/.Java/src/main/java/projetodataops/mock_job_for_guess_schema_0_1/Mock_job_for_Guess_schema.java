...
package projetodataops.mock_job_for_guess_schema_0_1;
...
// Exception is thrown if db don't support, no need to catch exception here
				...
				String fileName = (new java.io.File(
						"C:/Users/Débora/Desktop/Gabriel/FIAP/MBA/DataOps/TOS_BD-20200219_1130-V7.3.1/TOS_BD-20200219_1130-V7.3.1/temp/TempGuessSchemaDelimitedFile.csv"))
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Mock_job_for_Guess_schema.class.getClassLoader().getResourceAsStream(
					"projetodataops/mock_job_for_guess_schema_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 37684 characters generated by Talend Open Studio for Big Data on the 11 de
 * Maio de 2021 22h45min4s BRT
 ************************************************************************************************/
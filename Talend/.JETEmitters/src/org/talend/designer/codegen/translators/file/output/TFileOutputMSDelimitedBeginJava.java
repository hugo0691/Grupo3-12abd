...
public class TFileOutputMSDelimitedBeginJava
{
  ...
  protected final String TEXT_16 = ";" + NL + "    " + NL + "java.io.Writer out";
  protected final String TEXT_17 = " = new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "\tnew java.io.FileOutputStream(fileName_";
  protected final String TEXT_18 = ", false),";
  protected final String TEXT_19 = "));";
  protected final String TEXT_20 = NL + "String field_";
  protected final String TEXT_21 = ";" + NL + "if(field_";
  protected final String TEXT_22 = ".length() <= 0){" + NL + "\tthrow new IllegalArgumentException(\"Field delimited must be assigned a char.\");" + NL + "}";
  protected final String TEXT_23 = NL + "com.talend.csv.CSVWriter out";
  protected final String TEXT_24 = " = new com.talend.csv.CSVWriter(new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "    new java.io.FileOutputStream(fileName_";
  protected final String TEXT_25 = ", false), ";
  protected final String TEXT_26 = ")));" + NL + "out";
  protected final String TEXT_27 = ".setSeparator(";
  protected final String TEXT_28 = ");" + NL + " ";
  protected final String TEXT_29 = NL + "String row_";
  protected final String TEXT_30 = ";" + NL + "if(row_";
  protected final String TEXT_31 = ".length() > 0){" + NL + "\tout";
  protected final String TEXT_32 = ".setLineEnd(\"\"+row_";
  protected final String TEXT_33 = ".charAt(0));" + NL + "}else{" + NL + "\tthrow new IllegalArgumentException(\"Row delimited must be assigned a char.\");" + NL + "}" + NL + "" + NL + "String escapeChar_";
  protected final String TEXT_34 = ";" + NL + "if(escapeChar_";
  protected final String TEXT_35 = ".length() <= 0){" + NL + "\tthrow new IllegalArgumentException(\"Escape Char must be assigned a char.\");" + NL + "}" + NL + "" + NL + "String textEnclosure_";
  protected final String TEXT_36 = ";" + NL + "if(textEnclosure_";
  protected final String TEXT_37 = ".setQuoteChar(textEnclosure_";
  protected final String TEXT_38 = ".charAt(0));" + NL + "}else{" + NL + "\tthrow new IllegalArgumentException(\"Text Enclosure must be assigned a char.\");" + NL + "}" + NL + "" + NL + "if ((\"\\\\\\\\\").equals(escapeChar_";
  protected final String TEXT_39 = ")) {" + NL + "\tout";
  protected final String TEXT_40 = ".setEscapeChar('\\\\');" + NL + "} else if (escapeChar_";
  protected final String TEXT_41 = ".equals(textEnclosure_";
  protected final String TEXT_42 = ".setEscapeChar(textEnclosure_";
  protected final String TEXT_43 = ".charAt(0));" + NL + "} else {" + NL + "\tout";
  protected final String TEXT_44 = ".charAt(0));" + NL + "}" + NL + "out";
  protected final String TEXT_45 = ".setQuoteStatus(com.talend.csv.CSVWriter.QuoteStatus.FORCE);" + NL;
  protected final String TEXT_46 = NL + "\tjava.util.List<";
  protected final String TEXT_47 = "Struct> ";
  protected final String TEXT_48 = "List_";
  protected final String TEXT_49 = " = new java.util.ArrayList<";
  protected final String TEXT_50 = "Struct>();";
  protected final String TEXT_51 = NL + "\torg.talend.commons.utils.data.map.MultiLazyValuesMap ";
  protected final String TEXT_52 = "Map_";
  protected final String TEXT_53 = " = new org.talend.commons.utils.data.map.MultiLazyValuesMap(" + NL + "                    new java.util.HashMap()) {" + NL + "" + NL + "                public java.util.Collection instanciateNewCollection() {" + NL + "                    return new org.apache.commons.collections.list.GrowthList(3);" + NL + "                }" + NL + "" + NL + "            };" + NL + "   final ";
  protected final String TEXT_54 = "Struct[] EMPTY_ARRAY_";
  protected final String TEXT_55 = "_";
  protected final String TEXT_56 = " = new ";
  protected final String TEXT_57 = "Struct[0];";

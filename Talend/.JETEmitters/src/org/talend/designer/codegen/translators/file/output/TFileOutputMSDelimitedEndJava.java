...
public class TFileOutputMSDelimitedEndJava
{
  ...
  protected final String TEXT_18 = NL + "String tempStringM";
  protected final String TEXT_19 = " = null;" + NL + "            " + NL + "int tempLengthM";
  protected final String TEXT_20 = " = 0;" + NL + "" + NL + "StringBuilder sb_";
  protected final String TEXT_21 = " = new StringBuilder();";
  protected final String TEXT_22 = NL;
  protected final String TEXT_23 = NL + "if(out";
  protected final String TEXT_24 = "!=null) {" + NL + "\tout";
  protected final String TEXT_25 = ".close();" + NL + "}" + NL + "globalMap.put(\"";
  protected final String TEXT_26 = "_NB_LINE\",nb_line_";
  protected final String TEXT_27 = ");";
  protected final String TEXT_28 = NL + "if(nb_line_";
  protected final String TEXT_29 = " == 0){" + NL + "\tnew java.io.File(fileName_";
  protected final String TEXT_30 = ").delete();" + NL + "}";

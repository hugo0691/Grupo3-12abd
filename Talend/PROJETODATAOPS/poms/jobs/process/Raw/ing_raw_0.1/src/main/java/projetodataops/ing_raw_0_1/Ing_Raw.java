...
package projetodataops.ing_raw_0_1;
...
/**
 * Job: Ing_Raw Purpose: Ingestão dos dados na camada raw<br>
 * Description: Ingere os dados da base de dados AdventureWorks <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Ing_Raw implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Ing_Raw";
	private final String projectName = "PROJETODATAOPS";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Ing_Raw.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tFileOutputMSDelimited_1_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_PROJETODATAOPS_Ing_Raw = new byte[0];
    static byte[] commonByteArray_PROJETODATAOPS_Ing_Raw = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJETODATAOPS_Ing_Raw) {
...
String fileName_tFileOutputMSDelimited_1 = "C:/Users/Débora/Desktop/Gabriel/FIAP/MBA/DataOps/Grupo3-12abd/Talend/out.csv";
...
final String OUT_DELIM_ROWSEP_tFileOutputMSDelimited_1 = /** Start field tFileOutputMSDelimited_1:ROWSEPARATOR */"\n"/** End field tFileOutputMSDelimited_1:ROWSEPARATOR */;
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:7kBtfhKSxswSe8eBNcQ1qmt+vS7iiO7452/c1/GgDIILZKjhgQ==");
...
row1_tFileOutputMSDelimited_1.ProductCategoryID = row1.ProductCategoryID;
row1_tFileOutputMSDelimited_1.ParentProductCategoryID = row1.ParentProductCategoryID;
row1_tFileOutputMSDelimited_1.rowguid = row1.rowguid;
row1_tFileOutputMSDelimited_1.ModifiedDate = row1.ModifiedDate;
...
for (int row1_index_tFileOutputMSDelimited_1= 0; row1_index_tFileOutputMSDelimited_1 < row1List_tFileOutputMSDelimited_1.size(); row1_index_tFileOutputMSDelimited_1++) {
...
tempStringMtFileOutputMSDelimited_1=String.valueOf(row1_e.ProductCategoryID);
sb_tFileOutputMSDelimited_1.append(tempStringMtFileOutputMSDelimited_1);
sb_tFileOutputMSDelimited_1.append(";");
//get  and format output String begin
tempStringMtFileOutputMSDelimited_1=(row1_e.ParentProductCategoryID == null) ? "": String.valueOf(row1_e.ParentProductCategoryID);
sb_tFileOutputMSDelimited_1.append(tempStringMtFileOutputMSDelimited_1);
sb_tFileOutputMSDelimited_1.append(";");
//get  and format output String begin
tempStringMtFileOutputMSDelimited_1=(row1_e.rowguid == null) ? "": String.valueOf(row1_e.rowguid);
sb_tFileOutputMSDelimited_1.append(tempStringMtFileOutputMSDelimited_1);
sb_tFileOutputMSDelimited_1.append(";");
//get  and format output String begin
tempStringMtFileOutputMSDelimited_1=(row1_e.ModifiedDate == null) ? "": FormatterUtils.format_Date(row1_e.ModifiedDate, "dd-MM-yyyy");
sb_tFileOutputMSDelimited_1.append(tempStringMtFileOutputMSDelimited_1);
sb_tFileOutputMSDelimited_1.append("\n");
 ...
 */
    ...
    public static void main(String[] args){
        final Ing_Raw Ing_RawClass = new Ing_Raw();

        int exitCode = Ing_RawClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Ing_Raw.class.getClassLoader().getResourceAsStream("projetodataops/ing_raw_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Ing_Raw.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Ing_Raw");
        }
...
/************************************************************************************************
 *     40247 characters generated by Talend Open Studio for Big Data 
 *     on the 11 de Maio de 2021 23h1min5s BRT
 ************************************************************************************************/